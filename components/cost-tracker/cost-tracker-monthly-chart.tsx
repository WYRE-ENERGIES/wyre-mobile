    ...
    <View style={styles.container} onLayout={onLayout}>
      <View style={styles.legend}>
        <View style={styles.legendItem}>
          ...
          <Text style={[styles.legendText, { color: colors.textOnCardSecondary }]}>Diesel</Text>
        </View>
        <View style={styles.legendItem}>
          <View style={[styles.legendDot, { backgroundColor: WyreColors.orange }]} />
          <Text style={[styles.legendText, { color: colors.textOnCardSecondary }]}>Utility</Text>
        </View>
      </View>
