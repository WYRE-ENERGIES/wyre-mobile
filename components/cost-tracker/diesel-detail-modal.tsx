    ...
    <View style={styles.entryCard}>
      ...
      <View style={styles.entryMetrics}>
        <View style={styles.metric}>
          ...
          <Text style={styles.metricValue}>{formatLitres(entry.quantity)}</Text>
        </View>
        <View style={styles.metricDivider} />
        <View style={styles.metric}>
          <Text style={styles.metricLabel}>Hours</Text>
          <Text style={styles.metricValue}>{formatDecimalHours(entry.hours_of_use)}</Text>
        </View>
      </View>
    </View>
  );
      ...
      <View style={[styles.root, { paddingTop: insets.top }]}>
        <View style={styles.header}>
          <View style={styles.headerText}>
            <Text style={styles.title}>Daily diesel entries</Text>
            {month ? <Text style={styles.subtitle}>{month}</Text> : null}
          </View>
          ...
          <>
            <View style={styles.summaryRow}>
              <View style={styles.summaryCard}>
                ...
                <Text style={styles.summaryValue}>{formatLitres(summary.totalLitres)}</Text>
              </View>
              <View style={styles.summaryCard}>
            ...
            <FlatList
              ...
              ListEmptyComponent={
                <Text style={styles.empty}>No daily entries for this month.</Text>
              }
              ListFooterComponent={
                rows.length > 0 ? (
                  <Text style={styles.footer}>{rows.length} entries</Text>
                ) : null
              }
              renderItem={({ item }) => (
